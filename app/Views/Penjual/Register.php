    ...
    <div class="row justify-content-center">
        <div class="col-10 bg-primary my-5 text-white py-5">
            ...
            <form action="Register" method="POST">
                ...
                <div class="form-group">
                    <label for="deskripsi_diri">Desktripsi Diri</label>
                    <textarea class="form-control <?= ($validation->hasError('deskripsi_diri')) ? 'is-invalid' : '' ?>" id="deskripsi_diri" name="deskripsi_diri"><?= old('deskripsi_diri') ?></textarea>
                    <div class="invalid-feedback">
                        <?= $validation->getError("deskripsi_diri"); ?>
                    </div>
                </div>
