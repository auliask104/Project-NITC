            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 border p-4 bg-white">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control <?= ($validation->hasError('password')) ? 'is-invalid' : ''; ?>" id="password">
                                <div class="invalid-feedback">
                    ...
                    <div class="col-lg-5 border p-4 bg-white offset-lg-1">
                        ...
                        <div class="d-inline">
                            <a href="" class="button button-contactForm boxed-btn">Pembeli</a>
                            <a href="" class="button button-contactForm boxed-btn">Penjual</a>
                        </div>
                    </div>
                </div>
